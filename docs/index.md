...
The following chart (_figure 5_) shows an even more sustained trend that complements our observations, that is, the ratio of the number of replies per thread. This steady, and almost linear, increase over time of the number of replies to given threads show a certain 'maturity' of the list as it shows how Nettime dialogs are composed of an increasing number of messages and interlocutors.  
